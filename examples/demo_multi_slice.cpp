...
{
    {0,"10.10.0.1", 7000, "", 0, 2, 5, 0},
    {1,"10.10.0.2", 7000, "", 0, 2, 5, 0},
    {2,"10.10.0.3", 7000, "", 0, 2, 5, 0}
};

/* 有5个redis分片存储节点的xRedis集群 */
RedisNode RedisList2[5]=
{
    {0,"10.10.1.1", 7000, "", 0, 2, 5, 0},
    {1,"10.10.1.2", 7000, "", 0, 2, 5, 0},
    {2,"10.10.1.3", 7000, "", 0, 2, 5, 0},
    {3,"10.10.1.4", 7000, "", 0, 2, 5, 0},
    {4,"10.10.1.5", 7000, "", 0, 2, 5, 0},
};
